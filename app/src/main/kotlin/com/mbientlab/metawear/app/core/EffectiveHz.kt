...
/**
 * True-rate estimation over the most recent samples. Port of the effective-Hz
 * math in `StreamSessionViewModel.swift`: window the last [WINDOW_SAMPLES]
 * arrival times and divide `(count − 1)` by the spanned seconds. Returns 0
 * when fewer than two samples exist or the span is not positive.
 */
object EffectiveHz {
